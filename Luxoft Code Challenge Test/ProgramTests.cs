...
namespace LuxoftCodeChallenge.UnitTest
{
    ...
    public class ProgramTests
    {
        ...
        {
            //Arrange
            var currencyDenomination = new decimal[] { 0.01M, 0.05M, 0.10M, 0.25M, 0.50M, 1.00M, 2.00M, 5.00M, 10.00M, 20.00M, 50.00M, 100.00M };
            var cashier = new Cashier("USD", currencyDenomination);
